...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190121173640_accesLevel')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190121173640_accesLevel')
BEGIN
    ALTER TABLE [users] ADD [accesLevel] bit NOT NULL DEFAULT 0;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190121173640_accesLevel', N'2.1.4-rtm-31024');
END;
